...
.loader::before {
  ...
  top: -10px;
  background-repeat: no-repeat;
  background-image: linear-gradient(#000407 64px, transparent 0), linear-gradient(#000407 66px, transparent 0), radial-gradient(circle 4px, #000407 100%, transparent 0);
